        ...
        <CardContent className="p-8 flex flex-col items-center space-y-6">
          ...
          <div className="flex space-x-4">
            <Button
              ...
              size="icon"
              onClick={toggleTimer}
              className="w-16 h-10 bg-white/10 rounded-none border-white/10 hover:bg-white/20 hover:border-white/50 transition-all duration-300"
            >
              {isRunning ? 
                <Pause className="w-2 h-2 text-white/90" /> : 
                <p className="px-2 text-xs text-white/90 font-mono">スタート</p>
              }
            </Button>
            <Button
              variant="outline"
